...
But I implemented a another logic, more simple (we have the handle function :-).

- And now have a shortcuts (see it below in [Using](#usage)) (thanks for this sugest to gmag11)
